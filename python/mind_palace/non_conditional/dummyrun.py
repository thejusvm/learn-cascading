...
feed = {md.positive_samples : positive_samples_test, md.negative_samples : negative_samples_test}


for score in sess.run([md.prec_1, md.max_negative_score, md.positive_score, md.negative_score], feed_dict = feed):
    print score

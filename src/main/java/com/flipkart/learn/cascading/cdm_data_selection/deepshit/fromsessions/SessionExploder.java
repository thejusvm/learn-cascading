...
public class SessionExploder implements SimpleFlow {
    ...
    public static final Fields EXPLODER_TO_ENCODE_FIELDS = new Fields(REQ_CONTEXT, POSITIVE_PRODUCTS, NEGATIVE_PRODUCTS, PAST_CLICKED_SHORT_PRODUCTS, PAST_CLICKED_LONG_PRODUCTS, PAST_BOUGHT_PRODUCTS);
